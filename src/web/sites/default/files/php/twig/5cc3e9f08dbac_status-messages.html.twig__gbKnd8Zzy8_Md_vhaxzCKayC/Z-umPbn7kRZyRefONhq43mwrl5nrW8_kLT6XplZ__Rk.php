...
class __TwigTemplate_812394ce5cf527ad00fd0f8dc82987fe0c0397b28896b15fad080fa7a4fc6441 extends \Twig\Template
{
...
$context["type"] == "info")) ? ("alert-info") : (""))];
  ...
  <div aria-label=\"";
            ...
            echo "\" ";
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute(twig_without($this->sandbox->ensureToStringAllowed(($context["attributes"] ?? null)), "role", "aria-label"), "addClass", [0 => ($context["classes"] ?? null)], "method"), "setAttribute", [0 => "role", 1 => $this->getAttribute(($context["role"] ?? null), $context["type"], [], "array")], "method")), "html", null, true);
            echo ">
...
";
    ...
    {
        return new Source("", "themes/contrib/bootstrap_barrio/templates/misc/status-messages.html.twig", "/var/www/stadmin/data/www/repo/web/themes/contrib/bootstrap_barrio/templates/misc/status-messages.html.twig");
    }
}
