...
/* themes/custom/cpr_bootstrap_barrio/templates/block/block--navigareprincipala.html.twig */
class __TwigTemplate_d43d0289db3392cecf9f7dd825bb63b6007202341bf9809cfaefdcad3e75f17d extends \Twig\Template
{
...
($context["derivative_plugin_id"] ?? null))))];
        ...
        echo "\"";
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, twig_without($this->sandbox->ensureToStringAllowed($this->getAttribute(($context["attributes"] ?? null), "addClass", [0 => ($context["classes"] ?? null), 1 => "col-md-8", 2 => "offset-md-2"], "method")), "role", "aria-labelledby"), "html", null, true);
        echo ">
  ";
        // line 45
        echo "  ";
...
";
  ...
  ";
    ...
    {
        return "themes/custom/cpr_bootstrap_barrio/templates/block/block--navigareprincipala.html.twig";
    }
    ...
    {
        return new Source("", "themes/custom/cpr_bootstrap_barrio/templates/block/block--navigareprincipala.html.twig", "/var/www/stadmin/data/www/repo/web/themes/custom/cpr_bootstrap_barrio/templates/block/block--navigareprincipala.html.twig");
    }
}
