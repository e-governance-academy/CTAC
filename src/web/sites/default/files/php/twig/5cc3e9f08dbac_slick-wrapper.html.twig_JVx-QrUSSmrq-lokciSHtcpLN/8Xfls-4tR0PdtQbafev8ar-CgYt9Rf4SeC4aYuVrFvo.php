...
class __TwigTemplate_169f6afe8b05a6314847951bcd2e48add51ebd93b9a62a2ac62e88bf8c51ed88 extends \Twig\Template
{
...
";
        ...
        if ($this->getAttribute(($context["settings"] ?? null), "nav", [])) {
            // line 37
            echo "    <div";
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, twig_without($this->sandbox->ensureToStringAllowed($this->getAttribute(($context["attributes"] ?? null), "addClass", [0 => ($context["classes"] ?? null)], "method")), "id"), "html", null, true);
            echo ">
      ";
            // line 38
  ...
  ";
    ...
    {
        return new Source("", "modules/contrib/slick/templates/slick-wrapper.html.twig", "/var/www/stadmin/data/www/repo/web/modules/contrib/slick/templates/slick-wrapper.html.twig");
    }
}
